...
const PriceDetails: React.FC<PriceDetailsProp> = ({ totalAmount, totalDiscount, shippingCharge, totalOriginalAmount, itemCount, isProcessing, step, onProceed, onBack }) => {
    return (
